...
public class TinyDB {
    ...
    public ArrayList<PerfumeDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PerfumeDomain> playerList =  new ArrayList<PerfumeDomain>();

        for(String jObjString : objStrings){
            PerfumeDomain player  = gson.fromJson(jObjString,  PerfumeDomain.class);
    ...
    public <T> T getObject(String key, Class<T> classOfT){
        ...
        Object value = new Gson().fromJson(json, (Class<PerfumeDomain>) classOfT);
        if (value == null)
    ...
    public void putListObject(String key, ArrayList<PerfumeDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PerfumeDomain player: playerList){
